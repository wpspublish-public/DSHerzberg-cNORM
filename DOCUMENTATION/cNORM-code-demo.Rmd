...
with increasing age. Consequently, we expect that a specific raw score
will be associated with progressively lower norm scores as age
increases. This occurs because the mean raw score increases from one age
group to the next, and, as a result, an identical raw score moves to a
lower rank in the next oldest age group, and so on.
