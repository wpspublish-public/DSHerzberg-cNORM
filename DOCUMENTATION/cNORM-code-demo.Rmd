...
Creating a reversal report involves comparing the values of adjacent cells with rows. That kind of process is more easily handled when the data are in long, multi-level format.
